select  2015 as funding_year,
        ...
        sum(round(frns."Total Elig Chg"::numeric * (frns."Discount"::numeric/100),2)) as funding_commitment_request
...
select  2016 as funding_year,
        ...
        sum(frns.funding_commitment_request::numeric) as funding_commitment_request
from fy2016.frns 
group by 1, 2
