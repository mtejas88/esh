...
(ia_monthly_cost_total*(1 - discount_rate_c1_matrix)::numeric)*12 as total_cost_district, 
num_students
...
median(total_cost_district/num_students) as median_cost_per_student,
sum(total_cost_district)::numeric/sum(num_students) as avg_cost_per_student
from t
group by 1,2
union
