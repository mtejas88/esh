...
campus_build_costs = read_csv(GITHUB+'/Projects/funding_the_gap/data/interim/campus_build_costs_before_distribution.csv')
state_cost_per_mile = read_csv(GITHUB+'/Projects/funding_the_gap/data/interim/state_cost_per_mile.csv')
...
campus_build_costs.to_csv(GITHUB+'/Projects_SotS_2017/fiber/funding_the_gap_2017/data/interim/campus_build_costs_16.csv')
print("File saved")