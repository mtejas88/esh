...
state_metrics['extrapolated_total_cost'] = state_metrics['extrapolated_total_cost_ia'] + state_metrics['extrapolated_total_cost_median_wan']
state_metrics['extrapolated_discount_erate_funding'] = state_metrics['extrapolated_discount_erate_funding_ia'] + state_metrics['extrapolated_discount_erate_funding_median_wan']
state_metrics['extrapolated_total_state_funding'] = state_metrics['extrapolated_total_state_funding_ia'] + state_metrics['extrapolated_total_state_funding_median_wan']
state_metrics['extrapolated_total_erate_funding'] = state_metrics['extrapolated_total_erate_funding_ia'] + state_metrics['extrapolated_total_erate_funding_median_wan']
state_metrics['extrapolated_total_district_funding'] = 	state_metrics['extrapolated_total_district_funding_ia'] + state_metrics['extrapolated_total_district_funding_median_wan']
