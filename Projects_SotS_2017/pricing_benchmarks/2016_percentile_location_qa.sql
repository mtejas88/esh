...
with a as (select s.*,
 ...
 join public.fy2016_districts_deluxe_matr sd
...
PERCENTILE_CONT (0.33) WITHIN GROUP (ORDER BY sr.monthly_circuit_cost_mrc_unless_null) AS "33rd_percentile_mrc_unless_null",
PERCENTILE_CONT (0.36) WITHIN GROUP (ORDER BY sr.monthly_circuit_cost_mrc_unless_null) AS "36th_percentile_mrc_unless_null",
PERCENTILE_CONT (0.38) WITHIN GROUP (ORDER BY sr.monthly_circuit_cost_mrc_unless_null) AS "38th_percentile_mrc_unless_null",
PERCENTILE_CONT (0.39) WITHIN GROUP (ORDER BY sr.monthly_circuit_cost_mrc_unless_null) AS "39th_percentile_mrc_unless_null",
