...
count(distinct case when dd.service_provider_assignment is not null and dd.exclude_from_ia_analysis=false then dd.esh_id end) as num_districts_served_clean
