...
cur = conn.cursor()
cur.execute("""\
    	SELECT 	esh_id, nces_cd, district_type, include_in_universe_of_districts_all_charters, num_campuses, num_schools, exclude_from_ia_analysis, fiber_target_status, bw_target_status, current_assumed_unscalable_campuses, current_known_unscalable_campuses, fiber_metric_calc_group
