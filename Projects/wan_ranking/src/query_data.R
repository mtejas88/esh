...
setwd(paste(github_path, 'Projects/wan_ranking', sep=''))
...
wan_ranking <- querydb('src/wan_bw_ranking_assumptions.sql')
...
write.csv(wan_ranking, 'data/wan_ranking.csv', row.names = FALSE)