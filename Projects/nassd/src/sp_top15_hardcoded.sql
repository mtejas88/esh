...
students_not_meeting_100k_p,
students_not_meeting_100k,
students_meeting_100k

from sp_union

where year = 2017
and service_provider_assignment in ('Level 3','CenturyLink', 'Windstream' , 'Grande Comm', 'Cogent', 'Cox', 'Sunesys, LLC', 'Frontier','Computer Sciences','Charter','PHONOSCOPE LIGHT','Comcast','AT&T','ENA Services, LLC','Zayo Group, LLC')
...
union
  ...
  from sp_union  
union
  select 2016 as year, 'Charter' as service_provider_assignment, 0.24 as students_not_meeting_100k_p, 850000 as students_not_meeting_100k, 2730000 as students_meeting_100k
  from sp_union  
union
  select 2016 as year, 'PHONOSCOPE LIGHT' as service_provider_assignment, 0.24 as students_not_meeting_100k_p, 100000 as students_not_meeting_100k, 310000 as students_meeting_100k
  from sp_union  
union
  select 2016 as year, 'Comcast' as service_provider_assignment, 0.21 as students_not_meeting_100k_p, 660000 as students_not_meeting_100k, 2430000 as students_meeting_100k
  from sp_union  
union
  select 2016 as year, 'AT&T' as service_provider_assignment, 0.2 as students_not_meeting_100k_p, 1270000 as students_not_meeting_100k, 5050000 as students_meeting_100k
  from sp_union
union
  select 2016 as year, 'ENA Services, LLC' as service_provider_assignment, 0.2 as students_not_meeting_100k_p, 330000 as students_not_meeting_100k, 1330000 as students_meeting_100k
  from sp_union
union
