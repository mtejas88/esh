...
## store the datasets once per week
if (weekday == 'Monday'){
...
write.csv(smd_2017, paste("data/raw/2017_state_aggregation.csv", sep=""), row.names=F)
write.csv(smd_2016, paste("data/raw/2016_state_aggregation.csv", sep=""), row.names=F)
write.csv(dd_2017, paste("data/raw/2017_deluxe_districts.csv", sep=""), row.names=F)
write.csv(dd_2016, paste("data/raw/2016_deluxe_districts.csv", sep=""), row.names=F)
