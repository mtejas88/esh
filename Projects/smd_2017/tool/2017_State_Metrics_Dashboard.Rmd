...
renderDataTable({
  if(input$state == 'ALL'){
    datatable(upgrades_ct, rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  } else{
    datatable(upgrades_ct_sub(), rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  }
})
```
...
renderDataTable({
  if (input$state == 'ALL'){
    datatable(connectivity_ct, rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  } else{
    datatable(connectivity_ct_sub(), rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  }
})
```
...
renderDataTable({
  if (input$state == 'ALL'){
    datatable(fiber_ct, rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  } else{
    datatable(fiber_ct_sub(), rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  }
})
```
...
renderDataTable({
  if (input$state == 'ALL'){
    datatable(affordability_ct, rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  } else{
    datatable(affordability_ct_sub(), rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE))
  }
})
```
...
renderDataTable({
  if (input$state == 'ALL'){
    datatable(wifi_ct, rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE, fixed=TRUE))
  } else{
    datatable(wifi_ct_sub(), rownames=FALSE, escape=FALSE, options=list(paging=TRUE, searching=TRUE, scrollX=TRUE, fixed=TRUE))
  }
})
```
