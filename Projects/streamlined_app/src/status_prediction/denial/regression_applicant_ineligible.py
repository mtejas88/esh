...
feature_cols = ['denied_indicator_py', 'discount_category', 'service_Voice', 'frn_0_bids',  'internet_indicator',  'fulltime_enrollment']

insig_cols = ['locale_Rural', 'consultant_indicator', 'applicant_type_Library', 'applicant_type_School', 'applicant_type_Consortium', 'applicant_type_School District', 'applicant_type_Library System', 'copper_indicator', 'fiber_indicator', 'wireless_indicator', 'wan_indicator', 'service_Data Transmission and/or Internet Access', 'orig_denied_frn', 'total_eligible_one_time_costs', 'total_monthly_eligible_recurring_costs', 'total_funding_year_commitment_amount_request', 'line_items', 'num_recipients']
...
y = train['category_Applicant Ineligible']
...
y_res =  pd.DataFrame(data=y_res, index=range(rows), columns=['category_Applicant Ineligible'])
...
y_test = test['category_Applicant Ineligible']
