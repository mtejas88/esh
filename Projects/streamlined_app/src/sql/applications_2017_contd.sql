  select 
    ...
    fr_16_agg.funded_frns as funded_frns_16,
    fr_16_agg.denied_frns as denied_frns_16,
    fr_16_agg.frns as frns_16,
    fli_agg.functions,
    fli_agg.purposes,
    fli_agg.line_items,
  ...
  left join (
    ...
    and fr.committed_frn_service_type in ('Data Transmission and/or Internet Access', 'Voice')
    group by 1
  ) fr_16_agg    
  on bi.billed_entity_number = fr_16_agg.ben