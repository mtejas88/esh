...
and (case
	  	when fr.funding_year = '2017'
	  		then frns_17.fiber_sub_type is null or frns_17.fiber_sub_type != 'Special Construction'
	  	else frns_16.fiber_sub_type is null or frns_16.fiber_sub_type != 'Special Construction'
	  end)