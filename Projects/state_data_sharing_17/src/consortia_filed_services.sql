...
where (sr.consortium_shared = true or sr.purpose = 'Backbone')
...
and (li.applicant_type = 'Consortium' or li.applicant_type != 'District')
and sr.line_item_id in (
  ...
  group by sr.line_item_id
  having count(sr.recipient_id) > 1
)
