select distinct
  ...
  --commenting out as c2_funding view is not ready yet as of May 10, 2017
	...
	case
		...
		when  	(flag_array is null or
			...
			(flag_count = 2 and array_to_string(flag_array,',') ilike '%missing_wan%') and and array_to_string(flag_array,',') ilike '%dirty_wan%'))
						...
						--(flag_count = 1 and array_to_string(flag_array,',') ilike '%missing_wan%')) commenting out due to new flag logic above
	...
	budget_used_c2_16,*/ --commenting out as c2_funding view is not ready yet as of May 10, 2017
...
on dm.esh_id = c2.esh_id::varchar*/ --commenting out as c2_funding view is not ready yet as of May 10, 2017
