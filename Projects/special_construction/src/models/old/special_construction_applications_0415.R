...
## read in data 
spekC.joeF <- read.csv("data/external/special_construction_funding_decisions_joeF_04152017.csv", as.is=T, header=T)
spekC.joeF <- filter(spekC.joeF, Fiber.Sub.Type == 'Special Construction')
spekC.eshClean <- read.csv("data/external/special_construction_data_4172017.csv", as.is=T, header=T)
...
speKC.frns$heirarchy <- ifelse(!(speKC.frns$heirarchy == 99), 
                               ...
                               ifelse(speKC.frns$open_sc_flag > 0, 
                                      5, 
                                      99))
write.csv(speKC.frns, file = "data/interim/frns_with_inclusion_reasons_0417.csv")
...
write.csv(speKC.includedApps, file = "data/interim/special_construction_applications_0417.csv")
