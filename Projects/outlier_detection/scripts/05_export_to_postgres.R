...
github_path <-'~/Documents/ESH/ficher/General_Resources/postgres_driver/'
...
dml_script_tableaud_for_insert <- dml_builder(ucd,"insert","tableau_district" )
insert_error <- tryCatch(dbExecute(con,dml_script_tableaud_for_insert),error=function(e) e)
print(insert_error)
dml_script_tableaud_for_insert=NULL
...
# delete_error <- tryCatch(dbSendUpdate(con,"delete from public.outlier_line_item_report_data"),error=function(e) e)
