...
campus_build_costs = read_csv('../../data/interim/campus_build_costs_before_distribution.csv')
state_cost_per_mile = read_csv('../../data/interim/state_cost_per_mile.csv')
...
campus_build_costs.to_csv('../../data/interim/campus_build_costs.csv')
print("File saved")