...
campus_build_costs.to_csv(GITHUB+'/Projects/funding_the_gap_2017/data/interim/campus_build_costs_before_distribution.csv')
...
state_cost_per_mile.to_csv(GITHUB+'/Projects/funding_the_gap_2017/data/interim/state_cost_per_mile.csv')
print("File saved")
