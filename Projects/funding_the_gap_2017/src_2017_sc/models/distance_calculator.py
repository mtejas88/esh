...
##store
campuses.to_csv('/home/sat/sat_r_programs/funding_the_gap_2017/data/raw/campuses.csv')

##permanent distances file
campuses_distances = read_csv('/home/sat/sat_r_programs/funding_the_gap_2017/data/raw/campuses_distances.csv',index_col=0, dtype={'esh_id': str, 'campus_id': str})
...
if newcampuses.shape[0] > 0:
    ...
    campuses_distances.to_csv('/home/sat/sat_r_programs/funding_the_gap_2017/data/raw/campuses_distances.csv')
    campuses_distances.to_csv('/home/sat/sat_r_programs/funding_the_gap_2017/data/interim/campuses_distances.csv')
    print("File saved")
