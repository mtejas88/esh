...
state_wan_costs = state_wan_costs[['district_exclude_from_ia_analysis','min_total_cost_wan', 'min_discount_erate_funding_wan', 'min_total_state_funding_wan', 'min_total_erate_funding_wan',
'min_total_district_funding_wan', 'min_builds_wan', 'min_build_distance_wan', 'builds_wan', 'builds_az_wan',
...
state_metrics = merge(state_metrics, state_wan_costs, how='outer', on='district_postal_cd')
...
state_dirty_ia_costs = state_ia_costs[state_ia_costs['district_exclude_from_ia_analysis'] == True]
...
state_metrics['extrapolated_min_total_cost'] = state_metrics['extrapolated_total_cost_ia'].replace(NaN, 0) + state_metrics['min_total_cost_wan']
state_metrics['extrapolated_min_discount_erate_funding'] = state_metrics['extrapolated_discount_erate_funding_ia'].replace(NaN, 0) + state_metrics['min_discount_erate_funding_wan']
state_metrics['extrapolated_min_total_state_funding'] = state_metrics['extrapolated_total_state_funding_ia'].replace(NaN, 0) + state_metrics['min_total_state_funding_wan']
state_metrics['extrapolated_min_total_erate_funding'] = state_metrics['extrapolated_total_erate_funding_ia'].replace(NaN, 0) + state_metrics['min_total_erate_funding_wan']
state_metrics['extrapolated_min_total_district_funding'] = 	state_metrics['extrapolated_total_district_funding_ia'].replace(NaN, 0) + state_metrics['min_total_district_funding_wan']
...
state_metrics['extrapolated_max_total_cost'] = state_metrics['extrapolated_total_cost_ia'].replace(NaN, 0) + state_metrics['max_total_cost_wan']
state_metrics['extrapolated_max_discount_erate_funding'] = state_metrics['extrapolated_discount_erate_funding_ia'].replace(NaN, 0) + state_metrics['max_discount_erate_funding_wan']
state_metrics['extrapolated_max_total_state_funding'] = state_metrics['extrapolated_total_state_funding_ia'].replace(NaN, 0) + state_metrics['max_total_state_funding_wan']
state_metrics['extrapolated_max_total_erate_funding'] = state_metrics['extrapolated_total_erate_funding_ia'].replace(NaN, 0) + state_metrics['max_total_erate_funding_wan']
state_metrics['extrapolated_max_total_district_funding'] = 	state_metrics['extrapolated_total_district_funding_ia'].replace(NaN, 0) + state_metrics['max_total_district_funding_wan']
...
state_metrics['advice_max_cost_per_mile'] = where(state_metrics['max_total_cost_per_mile']>=100000,
														1,
														0)
state_metrics['advice_ia_builds'] = where(state_metrics['builds_ia']<10,
												-1,
												0)
