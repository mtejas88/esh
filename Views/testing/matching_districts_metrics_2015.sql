...
bandwidth_calc	as	(										
	select  district_esh_id,											
			...
			sum(case											
					when	((consortium_shared	=	TRUE	and	
								(internet_conditions_met	=	TRUE	or	isp_conditions_met	=	true))
...
select												
	...
	(ia_cost_direct_to_district	+	ia_cost_backbone_pieces)/(case									
																when	com_info_bandwidth	>	0								
																	then	com_info_bandwidth										
																when	upstream_bandwidth	=	0								
																	then	isp_bandwidth										
															  ...
															  end	+	internet_bandwidth)	as	ia_cost_per_mbps_calc							
