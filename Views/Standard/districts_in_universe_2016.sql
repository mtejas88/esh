...
where ( 
        ...
        or ("LSTATE" in ('VT', 'NY')
            and "TYPE" = '3') )
and "LSTATE" not in ('AE', 'AP', 'AS', 'GU', 'MP', 'PR', 'VI', 'DD') 
and left("ULOCAL",1) in ('1', '2', '3', '4')      
and ( sc.student_count - sc.student_pk_count  >0 
      or ("LSTATE" = 'MT' and sc_MT.student_count - sc_MT.student_pk_count  >0) 
      or ("LSTATE" = 'VT' and sc_VT.student_count - sc_VT.student_pk_count  >0) 
      or "FIPST" = '59' )                                                       
and ( sc.school_count > 0 
      or ("LSTATE" = 'MT' and sc_MT.school_count>0)  
      or ("LSTATE" = 'VT' and sc_VT.school_count>0) ) 
and "BOUND" != '2' 
and case 
