    ...
    select distinct
    	...
    	case
          ...
          and array_to_string(flag_array,',') ilike '%dirty_wan%') or
          flag_array is null --adding flag array null logic
    		...
    		/*when  	(flag_array is null or
    				    (flag_count = 1 and array_to_string(flag_array,',') ilike '%missing_wan%'))*/ -- new changes based on flags is added so commenting this
