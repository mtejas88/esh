    ...
    mainPanel(
      navbarPage("",
                 ...
                 navbarMenu("Goals",
                            ...
                            tabPanel("Districts Meeting Goals, by IA Technology", plotOutput("histogram_districts_meeting_goals_ia"), tableOutput("table_districts_meeting_goals_ia"))),
                 navbarMenu("Fiber",
                            ...
                            tabPanel("Distribution of Districts by E-Rate Discount Rates", plotOutput("histogram_districts_erate"), tableOutput("table_districts_erate"))),
