...
services <- read.csv("services_received_20160715.csv", as.is = TRUE)
districts <- read.csv("deluxe_districts_20160715.csv", as.is = TRUE)
...
schools_needing_wan <- read.csv("schools_needing_wan_20160715.csv", as.is = TRUE)
